...
export default function Intro() {
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-23 w-23 sm:h-70 sm:w-70 rounded-full object-cover border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
      ...
      <motion.h1
        className="mb-8 mt-4 px-4 text-xl font-medium !leading-[1.5] sm:text-4xl"
      ...
      >
        ...
        <a
          ...
          href="https://github.com/izzati21001401"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
